        ...
        <div className="lg:min-h-screen flex fle-col items-center justify-center p-6">
            <div className="grid lg:grid-cols-2 items-center gap-10 max-w-6xl max-lg:max-w-lg w-full">
                <div>
                    ...
                    <p className="text-[15px] mt-6 lg:mt-12 text-slate-600">Already have an account <Link to="/login" className="text-blue-600 font-medium hover:underline ml-1">Login here</Link></p>
                </div>
